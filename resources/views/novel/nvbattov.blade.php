...
@section('subnovel')
        <div class="col-sm-2">
            <div class="list-group" id="list-tab" role="tablist">
                <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Episode 1</a>
                <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-home2" role="tab" aria-controls="profile">Episode 2</a>
                <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-home3" role="tab" aria-controls="messages">Episode 3</a>
                <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-home4" role="tab" aria-controls="settings">Episode 4</a>
                <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-home5" role="tab" aria-controls="profile">Episode 5</a>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="list-home3" role="tabpanel" aria-labelledby="list-messages-list">...</div>
                <div class="tab-pane fade" id="list-home4" role="tabpanel" aria-labelledby="list-settings-list">...</div>
                <div class="tab-pane fade" id="list-home5" role="tabpanel" aria-labelledby="list-profile-list">...</div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="row">
